...
Apply the HPA Formula:$$\text{desiredReplicas} = \left\lceil 3 \times \left( \frac{80\%}{60\%} \right) \right\rceil$$$$\text{desiredReplicas} = \left\lceil 3 \times 1.333 \right\rceil$$$$\text{desiredReplicas} = \left\lceil 4.0 \right\rceil = 4$$
