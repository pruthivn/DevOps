...
EX: you changed ip of your DNS but users still routing to old ip Their browser caches the old IP (1.1.1.1) for 5 minutes. you set TTL 300 seconds after completing 300 seconds you will get new updates(new ip) till then their browsers refuse to check Route 53 for updates until the timer hits zero.
